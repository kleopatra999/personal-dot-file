...
alias ydda="gaon; youtube-dl -f 'bestvideo[height<=?1081] + bestaudio/best'"
alias yddba="gaon; youtube-dl -f 'bestaudio/best' --audio-quality 0"
alias yddba3="gaon; youtube-dl -f 'bestvideo[height<=?1081] + m4a'"
